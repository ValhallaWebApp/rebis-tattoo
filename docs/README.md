...
Questa cartella contiene la documentazione tecnica rigenerata del frontend Angular (`gestionale-tattuaggi`).
...
## Contesto sintetico
- Frontend Angular 18 con moduli public/client/admin.
- Integrazione Firebase (Auth, Firestore, RTDB).
- Fast-booking con pagamento Stripe Elements e backend payments esterno.
- Config runtime tramite `public/app-config.js`.
